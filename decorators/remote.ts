...
export interface IRemoteOptions {
  ...
  /**
   * Called before service call
   */
  onBeforeCall?: ResolveRemoteVarFunction;

  /**
   * Called after service call
   */
  onAfterCall?: ResolveRemoteVarFunction;

  /**
   * Called for parse/format service response
   */
  onResult?: ResolveRemoteVarFunction;
}
